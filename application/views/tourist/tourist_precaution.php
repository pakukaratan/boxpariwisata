    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <section class="row posts">
                <header><h1 class="text-danger text-center">Precautions Articles</h1></header>
                <br><br><br>
                <?php foreach($precautions as $precaution):?>
                    <article class="post">
                        <div class="row well">
                            <div class="precaution-img col-md-6">
                                <img class="img-responsive" src="<?= base_url('assets/img/'.$precaution->image);?>">
                            </div>
                            <div class="col-md-4">
                                <span class="spot-name text-info"><?= $precaution->title;?></span> <br>
                                <p class="text-justify"><?= substr($precaution->description,200);?></p>
                            </div>
                            <div class="col-md-offset-1 col-md-1">
                                <a href="<?= base_url("precaution/$precaution->id") ?>" class="btn btn-primary">View</a>
                            </div>
                        </div> 
                    </article>
                <?php endforeach;?>
