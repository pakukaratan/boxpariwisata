            ...
            <div class="col-md-10 col-md-offset-1">
                <form action="<?php echo base_url('admin/tourist/update');?>" class="form-horizontal" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="nationality" value="<?php echo $tourist->nationality;?>" placeholder="Indonesia">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="birth_place" value="<?php echo $tourist->birth_place;?>" placeholder="Indonesia">
                        </div>
                    </div>
