...
class Tourist extends CI_Controller
{
    ...
    public function paySpot($book_id = '')
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $this->touristModel->updateBookSpotStatus($book_id, 'Waiting Confirmation');
            return redirect('tourist/spot/booking/history');
        } else {
            return redirect('tourist/login');
        }
    ...
    public function payRestaurant($book_id = '')
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $this->touristModel->updateBookRestaurantStatus($book_id, 'Waiting Confirmation');
            return redirect('tourist/restaurant/booking/history');
        } else {
            return redirect('tourist/login');
        }
    ...
    public function getTouristCurrency($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | Currency';
        $data['active'] = 'infotips';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_currency', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    public function getTouristTimeDiff($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | Time Difference';
        $data['active'] = 'infotips';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_timediff', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }

    //========================== start Tourist Etiquette =============================//
    public function getTouristEtiquette($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | Etiquette';
        $data['active'] = 'etiquette';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $data['etiquettes'] = $this->touristModel->getTouristEtiquette();
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_etiquette', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    public function getTouristEtiquetteBy($id = NULL)
    {
        if ($id == NULL) {
            redirect('/');
        }
        ...
        $data['tourist'] = $this->tourist;
        $data['error'] = NULL;
        $data['etiquettes'] = $this->touristModel->getTouristEtiquetteBy($id);
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_etiquette_view', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    //========================== end Tourist Etiquette =============================//

    //========================== start Tourist Tipping =============================//
    public function getTouristTipping($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | Tipping';
        $data['active'] = 'tipping';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $data['tippings'] = $this->touristModel->getTouristTipping();
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_tipping', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    public function getTouristTippingBy($id = NULL)
    {
        if ($id == NULL) {
            redirect('/');
        }
        ...
        $data['tourist'] = $this->tourist;
        $data['error'] = NULL;
        $data['tippings'] = $this->touristModel->getTouristTippingBy($id);
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_tipping_view', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    //========================== end Tourist Tipping =============================//

    //========================== start Tourist Precaution =============================//
    public function getTouristPrecaution($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | Precaution';
        $data['active'] = 'precaution';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $data['precautions'] = $this->touristModel->getTouristPrecaution();
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_precaution', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    public function getTouristPrecautionBy($id = NULL)
    {
        if ($id == NULL) {
            redirect('/');
        }
        ...
        $data['tourist'] = $this->tourist;
        $data['error'] = NULL;
        $data['precautions'] = $this->touristModel->getTouristPrecautionBy($id);
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_precaution_view', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    //========================== end Tourist Precaution =============================//

    //========================== start Tourist LatestNews =============================//
    public function getTouristLatestNews($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | LatestNews';
        $data['active'] = 'latestnews';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $data['latestnewss'] = $this->touristModel->getTouristLatestNews();
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_latestnews', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    public function getTouristLatestNewsBy($id = NULL)
    {
        if ($id == NULL) {
            redirect('/');
        }
        ...
        $data['tourist'] = $this->tourist;
        $data['error'] = NULL;
        $data['latestnewss'] = $this->touristModel->getTouristLatestNewsBy($id);
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_latestnews_view', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    //========================== end Tourist LatestNews =============================//

    //========================== start Tourist Traffic =============================//
    public function getTouristTraffic($error = NULL)
    {
        if ($this->session->userdata('tourist_logged_in')) {
            $tourist_id = $this->session->userdata('tourist_logged_in')['id'];
            $this->tourist = $this->touristModel->getTouristById($tourist_id);
        ...
        $ip = $_SERVER['REMOTE_ADDR'];
        $details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
        $data['title'] = $this->site_name . ' | Traffic';
        $data['active'] = 'traffic';
        $data['tourist'] = $this->tourist;
        $data['error'] = $error;
        $data['current_location'] = $details->city;
        $data['traffics'] = $this->touristModel->getTouristTraffic();
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_traffic', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    public function getTouristTrafficBy($id = NULL)
    {
        if ($id == NULL) {
            redirect('/');
        }
        ...
        $data['tourist'] = $this->tourist;
        $data['error'] = NULL;
        $data['traffics'] = $this->touristModel->getTouristTrafficBy($id);
        $this->load->view('tourist/partials/head', $data);
        $this->load->view('tourist/partials/navbar', $data);
        $this->load->view('tourist/tourist_traffic_view', $data);
        $this->load->view('tourist/partials/bottom', $data);
    }
    //========================== end Tourist Traffic =============================//
}
