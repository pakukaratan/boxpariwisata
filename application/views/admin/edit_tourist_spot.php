            ...
            <div class="col-md-10 col-md-offset-1">
                <form action="<?php echo base_url('admin/tourist-spot/update');?>" class="form-horizontal" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="open_time" value="<?php echo $spot->open_time;?>" placeholder="hh:mm">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="close_time" value="<?php echo $spot->close_time;?>" placeholder="hh:mm">
                        </div>
                    </div>
