    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <section class="row posts">
                <header><h1 class="text-danger text-center">Tourist spots in <?php echo $current_location;?> </h1></header>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <article class="post">
                        <div class="row well">
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="spot-info"><b>Open Hour: </b><?= $spot->open_time;?></span> <br>
                                <span class="spot-info"><b>Close Hour: </b><?= $spot->close_time;?></span> <br>
                            ...
                            <div class="col-md-offset-1 col-md-1">
                                <a href="<?= base_url("tourist/book/spot/$spot->id") ?>" class="btn btn-primary">Book</a>
                            </div>
                        </div> 
                    </article>
                <?php endforeach;?>
