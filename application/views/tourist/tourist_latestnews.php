    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <section class="row posts">
                <header><h1 class="text-danger text-center">Latest Newss Articles</h1></header>
                <br><br><br>
                <?php foreach($latestnewss as $latestnews):?>
                    <article class="post">
                        <div class="row well">
                            <div class="latestnews-img col-md-6">
                                <img class="img-responsive" src="<?= base_url('assets/img/'.$latestnews->image);?>">
                            </div>
                            <div class="col-md-4">
                                <span class="spot-name text-info"><?= $latestnews->title;?></span> <br>
                                <p class="text-justify"><?= substr($latestnews->description,200);?></p>
                            </div>
                            <div class="col-md-offset-1 col-md-1">
                                <a href="<?= base_url("latestnews/$latestnews->id") ?>" class="btn btn-primary">View</a>
                            </div>
                        </div> 
                    </article>
                <?php endforeach;?>
