    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <section class="row posts">
                <header><h1 class="text-danger text-center">Book Restaurants</h1></header>
                <br><br><br>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php foreach ($restaurant_tables as $restaurant_table):?>
                                        <form action="<?= base_url("tourist/book/restaurant/table/$restaurant_table->id") ?>" class="form-horizontal" method="post">
                                            <input type="hidden" name="tourist_restaurant_id" value="<?= $restaurant_table->restaurant_id ?>" />
                                            <tr>
                                                <td><input type="text" class="form-control" name="booking_no" value="<?= $restaurant_table->table_no ?>" readonly /></td>
                                                <td><input type="text" class="form-control" name="rate" value="<?= $restaurant_table->rate ?>" readonly /></td>
                                                <td>
