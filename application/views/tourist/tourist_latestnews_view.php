    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <?php foreach($latestnewss as $latestnews):?>
                <header><h1 class="text-danger text-center"><?= $latestnews->title;?></h1></header>
                <br><br><br>
                    <article class="post">
                        <div class="row well">
                            <div class="latestnews-img col-md-12">
                                <center><img class="img-responsive" height="40%" width="40%" src="<?= base_url('assets/img/'.$latestnews->image);?>"></center>
                            </div>
                            <div class="col-md-12"></div>
                            <div class="col-md-12">
                                <br/><br/>
                                <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;<?= $latestnews->description;?></p>
                            </div>
                        </div> 
                    </article>
                <?php endforeach;?>
